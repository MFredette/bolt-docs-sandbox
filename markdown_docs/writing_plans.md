...
[Converting YAML plans to Puppet plans](writing_yaml_plans.md#)
...
|[profiles::nginx\_install plan](https://github.com/puppetlabs/bolt/blob/master/docs/11-apply-manifest-code/Boltdir/site/profiles/plans/nginx_install.pp)|Shows an example plan for deploying Nginx and HAProxy.|Advanced|
